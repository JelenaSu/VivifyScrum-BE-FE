...
class Board {
    ...
    get nextBtnFirst() {
        return cy.get('[class="el-button vs-c-button-focus el-button--success el-button--large"]').last();
    }
    ...
    editBoardFunction(boardId, name, description) {
        cy.visit("/");
        cy.url().should('contain', '/my-organization')
        cy.intercept('PUT',`https://cypress-api.vivifyscrum-stage.com/api/v2/boards/${boardId}`).as("editBoard")
